...
public interface IExercise9 {
	 ...
	 * @throws IOException
	 */
	Map<Feature, Double> getFinalProbs(List<HMMDataStore<AminoAcid, Feature>> trainingPairs) throws IOException;
	 ...
	 *            A pre-trained HMM.
	 * @param finalProbs
	 *            The probabilities of the final state being a particular state.
	 ...
	 * @throws IOException
	 */
	Map<List<Feature>, List<Feature>> predictAll(HiddenMarkovModel<AminoAcid, Feature> model, Map<Feature, Double> finalProbs,
